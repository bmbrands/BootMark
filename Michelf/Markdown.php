...
class MarkdownExtra extends Markdown {
    ...
    protected $block_tags_re = 'p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|address|form|fieldset|iframe|hr|legend|article|section|label|nav|aside|hgroup|header|footer|figcaption';
